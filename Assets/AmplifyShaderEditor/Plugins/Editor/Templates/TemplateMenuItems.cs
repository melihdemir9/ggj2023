...
namespace AmplifyShaderEditor
{
	public class TemplateMenuItems
	{
		...
		[MenuItem( "Assets/Create/Amplify Shader/Templates/Legacy/UIDefault-ExtAlpha", false, 85 )]
		public static void ApplyTemplateTemplatesLegacyUIDefaultExtAlpha()
		{
			AmplifyShaderEditorWindow.CreateConfirmationTemplateShader( "cfe9be3b3c286cc4cae70ab8d6844ac8" );
		}
