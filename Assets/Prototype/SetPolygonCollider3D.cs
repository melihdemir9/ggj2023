using System.Collections;
 ...
 {
     public static void UpdatePolygonCollider2D(Mesh mesh, PolygonCollider2D polygonColliderOut)
     {
         if(mesh == null)
         {
             return;
         ...
         polygonColliderOut.pathCount = 1;
         ...
         EditorUtility.SetDirty(polygonColliderOut);
 
         polygonColliderOut.SetPath(0, newPoints);
     }
 }
